...
function main(allowedUsername, slotNumber)
    ...
    local LINE_SPACING = 7  -- Changed to 7
            ...
            if myChar and targetChar then
                ...
                if myRoot and targetRoot then
                    ...
                    if formationType == "line" then
                        -- Behind, straight line, facing forward, spacing 7
                        local look = targetRoot.CFrame.LookVector
                        pos = targetRoot.Position - look * (slotNumber * LINE_SPACING)  -- LINE_SPACING = 7
                    ...
                    elseif formationType == "lineup" then
                        local look = targetRoot.CFrame.LookVector
                        pos = targetRoot.Position - look * (slotNumber * LINEUP_SPACING)  -- LINEUP_SPACING = 6
                        myRoot.CFrame = CFrame.lookAt(pos, pos + look)
